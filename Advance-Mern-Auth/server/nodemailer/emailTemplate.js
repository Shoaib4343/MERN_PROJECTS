...
export const WELCOME_MESSAGE_TEMPLATE = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    ...
    <p>Thank you for creating an account with <strong>Auth Company</strong>! We’re excited to have you in our community.</p>
    ...
    <ul>
      ...
      <li>Visit our <a href="{helpCenterURL}" style="color:#4CAF50; text-decoration:none;">Help Center</a> for tips and tutorials.</li>
    </ul>

    <div style="text-align:center; margin: 30px 0;">
      <a href="{dashboardURL}" style="background:#4CAF50; color:#fff; padding:12px 24px; text-decoration:none; border-radius:5px; font-weight:bold;">Go to Dashboard</a>
    </div>
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    ...
    <div style="text-align: center; margin: 30px 0;">
      <span style="font-size: 32px; font-weight: bold; letter-spacing: 5px; color: #F57C00;">{resetOtp}</span>
    </div>
